...
<html>
    ...
    <head>
        ...
        <title>Hizip根据地-下载</title>
        <!--<link rel="shortcut icon" href="<?php echo THEMEPATH; ?>/img/folder.png">-->
        <link rel="shortcut icon" href="http://hizip.net/hizip.ico">

        <!-- STYLES -->
        <link rel="stylesheet" href="<?php echo THEMEPATH; ?>/bootstrap.min.css">
        <link rel="stylesheet" href="<?php echo THEMEPATH; ?>/font-awesome.min.css">
        <link rel="stylesheet" type="text/css" href="<?php echo THEMEPATH; ?>/css/style.css">

        <!-- SCRIPTS -->
        <script type="text/javascript" src="http://apps.bdimg.com/libs/jquery/2.1.3/jquery.min.js"></script>
        <script src="<?php echo THEMEPATH; ?>/bootstrap.min.js"></script>
